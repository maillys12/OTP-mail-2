...
อัปเดตความเร็วหน้าเว็บ
----------------------
- หน้าเติมเครดิต ร้านค้า และ YouTube จะแสดงบัญชีและข้อมูลล่าสุดจากแคชในเครื่องทันที
- ระบบจะตรวจ Session และดึงข้อมูลใหม่จาก Apps Script แบบเงียบ ๆ เบื้องหลัง
- หน้าหลักจะเตรียมข้อมูลร้านค้า ประวัติการซื้อ รายการ YouTube และกล่องข้อความไว้ล่วงหน้า
- หลังซื้อสินค้า สั่ง YouTube หรือยอดเครดิตเปลี่ยน แคชจะถูกอัปเดตตามข้อมูลล่าสุด
- เมื่อออกจากระบบ ระบบจะล้างแคชทั้งหมดเพื่อไม่ให้ข้อมูลของบัญชีเดิมค้างอยู่

อัปเดตดีไซน์ Dark Cocoa
------------------------
- ทุกหน้าเปลี่ยนเป็นธีมพื้นเข้มโทนน้ำตาล พร้อมสีส้มเป็นสีหลัก
- หน้ารับ OTP แสดงบริการทั้งหมดเป็นการ์ดแอป พร้อมช่องค้นหา
- ราคาบนการ์ดเป็นราคาเริ่มต้น 7 บาท ส่วนราคาจริงจะตรวจจากหลังบ้านหลังเลือกประเทศ
- เมื่อกดการ์ดแอป ระบบจึงเปิดหน้าต่างเลือกประเทศและปุ่มซื้อหมายเลข
- แอปยอดนิยมใช้ไอคอนแบรนด์ ส่วนบริการอื่นจะแสดงอักษรตัวแรกโดยอัตโนมัติ
- โทรศัพท์และแท็บเล็ตมีแถบเมนูด้านล่างเพื่อเปลี่ยนหน้าได้สะดวก

อัปเดตประเทศ แอปยอดนิยม และรายการล่าสุด
------------------------------------------
- ตัวเลือกประเทศอยู่ด้านบนของรายการบริการ และเริ่มต้นที่ Thailand (52)
- เมื่อกดการ์ดแอป ระบบใช้ประเทศที่เลือกด้านบนเพื่อตรวจสอบราคา ไม่ถามประเทศซ้ำ
- แอปยอดนิยมจากรายการตัวอย่างถูกเรียงขึ้นก่อน จากนั้นจึงตามด้วยบริการอื่นทั้งหมดจาก API
- รายการ API จำนวนมากจะค่อย ๆ แสดงเป็นชุด เพื่อไม่ให้หน้าเว็บค้างบนโทรศัพท์หรือแท็บเล็ต
- เพิ่มรายการสั่งซื้อล่าสุดแบบเลื่อนอัตโนมัติและอัปเดตทุก 30 วินาที
- หมายเลขในรายการล่าสุดถูกปิดบัง และไม่ส่ง Username ของผู้ซื้อออกจากระบบหลังบ้าน

การอัปเดตรอบนี้
---------------
ต้องวาง Code.gs ฉบับใหม่และ Deploy เป็น New version เพราะเพิ่ม API:
- getCountryCatalog
- getRecentOrders

จากนั้นจึงอัปโหลดไฟล์หน้าเว็บขึ้น GitHub/Vercel
